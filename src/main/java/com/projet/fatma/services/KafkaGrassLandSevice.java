...
public class KafkaGrassLandSevice {
    ...
    public GrasslandProducer create(GrassLand grassLand) {
        ...
        LOGGER.info("Grassland created and sent to Kafka: " + grassLand);
    ...
    public GrasslandProducer update(String grassLandId, GrassLand grassLand) {
        ...
        GrasslandProducer existingGrassP = grasslandRepository.findByStringId(grassLandId)
                .orElseThrow(() -> new EntityNotFoundException("Grassland not found with ID: " + grassLandId));
        ...
        existingGrassP.setDescriptionGrassland(newgrassLand.getDescriptionGrassland());
        existingGrassP.setStartGrasslandManagement(newgrassLand.getStartGrasslandManagement());
        existingGrassP.setWithoutGrasslandManagement(newgrassLand.getWithoutGrasslandManagement());
        existingGrassP.setWithGrasslandManagement(newgrassLand.getWithGrasslandManagement());
        existingGrassP.setWithoutFireManagement(newgrassLand.getWithoutFireManagement());
        existingGrassP.setWithFireManagement(newgrassLand.getWithFireManagement());
        existingGrassP.setStartYield(newgrassLand.getStartYield());
        existingGrassP.setWithoutYield(newgrassLand.getWithoutYield());
        existingGrassP.setWithYield(newgrassLand.getWithYield());
        existingGrassP.setStartAreaGrassland(newgrassLand.getStartAreaGrassland());
        existingGrassP.setWithoutAreaGrassland(newgrassLand.getWithoutAreaGrassland());
        existingGrassP.setWithAreaGrassland(newgrassLand.getWithAreaGrassland());
        existingGrassP.setWithoutTotEmissionsGrassland(newgrassLand.getWithoutTotEmissionsGrassland());
        existingGrassP.setWithTotEmissionsGrassland(newgrassLand.getWithTotEmissionsGrassland());
    ...
    public void delete(String grassLandId) {
        ...
        if (existingLandUse.isPresent()) {
            ...
            throw new EntityNotFoundException("Grassland not found with ID: " + grassLandId);
        }
    }
